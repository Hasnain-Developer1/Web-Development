                    ...
                    <div className=' flex flex-col p-4 text-black gap-8 items-center'>
                        ...
                        <div className="flex flex-col md:flex-row w-full justify-between gap-8">
                            ...
                            <div className="relative flex items-center">
                                <input value={form.password} onChange={handleChange} placeholder='Enter Password' className='rounded-full border border-green-500 w-full px-4 py-1 text-black' type={isPasswordVisible ? 'text' : 'password'} name="password" id="password" />
                                <span className='absolute right-1 top-{2px} cursor-pointer' onClick={showpassword}>
                                    <img className='p-1' width={30} src={isPasswordVisible ? '/icons/EyeCross.png' : '/icons/Eye.png'} alt="eye" />
                                </span>
                            </div>
                        </div>
