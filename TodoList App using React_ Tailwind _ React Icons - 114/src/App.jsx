  ...
  return (
    <>
      ...
      <div className="mx-2 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[35%]">
        ...
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <div className='flex'>
            ...
            <button
              ...
              className='bg-violet-800 hover:bg-violet-950 mx-2 rounded-lg p-4 py-2 text-sm font-bold text-white  disabled:bg-violet-700 enabled:cursor-pointer'
            >
              {editId ? "Update" : "Save"}
            </button>
          </div>
        ...
        <div className="h-px bg-black opacity-15 w-full my-2"></div>
              ...
              >
                ...
                <div className="buttons flex h-full">
                  ...
                  <button
                    ...
                    className='bg-violet-800 hover:bg-violet-950 p-2 py-1 text-sm font-bold text-white rounded-sm mx-1'
                  >
                    <FaEdit />
                  </button>
