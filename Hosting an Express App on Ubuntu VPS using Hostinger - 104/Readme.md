# How to host Node.js app on ubuntu

### Step1 - Installing Node.js & Build Essential
```
...
### Step2 - Creare a sample Node.js app
you can use your own app if you want to host it. Otherwise if you are just trying out, you can use a sample app
